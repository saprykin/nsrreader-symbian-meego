...
void
GIFFManager::add_chunk(GUTF8String name, const TArrayDj<char> & data)
...
GIFFManager::load_chunk(IFFByteStream & istr, GP<GIFFChunk> chunk)
{
  ...
  while ((chunk_size=istr.get_chunk(chunk_id)))
  {
    ...
    {
      TArrayDj<char> data(chunk_size-1);
...
void
GIFFManager::load_file(const TArrayDj<char> & data)
{
...
void
GIFFManager::save_file(TArrayDj<char> & data)
{
